...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://RozaB:Mymongodb6724!@cluster0.yc593od.mongodb.net/meetups?retryWrites=true&w=majority"); //Step1
